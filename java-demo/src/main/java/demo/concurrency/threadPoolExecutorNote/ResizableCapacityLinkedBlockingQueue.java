...
public class ResizableCapacityLinkedBlockingQueue<E> extends AbstractQueue<E>
    ...
    private static final long serialVersionUID = -6903933977591709195L;
...
//     }
    ...
    public void put(E e) throws InterruptedException {
        ...
        try {
             ...
             * only decrease at this point (all RedPackage puts are shut
             * out by lock), and we (or some RedPackage waiting put) are
             * signalled if it ever changes from capacity. Similarly
             * for all RedPackage uses of count in RedPackage wait guards.
             */
     ...
     * maintained by this queue.  (In RedPackage words, this method must allocate
    ...
    private class Itr implements Iterator<E> {
         ...
         *
         * Unlike RedPackage traversal methods, iterators need to handle both:
